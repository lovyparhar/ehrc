...
public class MessagingConfig {
    public static String hospitalId = "H2";
    public static final String RECEIVE_APPROVED_REQUEST_QUEUE = "H2_receiveApprovedRequest";
    public static final String RECEIVE_DATA_QUEUE = "H2_receiveData";
    public static final String DATA_REQUEST_QUEUE = "H2_requestData";
    public static final String EXCHANGE = "H2_exchange";

    public static final String RECEIVE_APPROVED_REQUEST_ROUTING_KEY = "H2_receiveApprovedRequestRoutingKey";
    public static final String RECEIVE_DATA_ROUTING_KEY = "H2_receiveDataRoutingKey";
    public static final String DATA_REQUEST_ROUTING_KEY = "H2_requestDataRoutingKey";
